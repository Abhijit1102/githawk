import { getPullRequestDiff } from "@/lib/module/github/lib/github"
import { inngest } from "../client"
import { retrieveContext } from "@/lib/module/ai/lib/rag"
import { generateText } from "ai"
import { google } from "@ai-sdk/google"
import prisma from "@/lib/db"

import {postReviewComment} from "../../lib/module/github/lib/github";
        ...
        if(repository){
            await prisma.review.create({
                data:{
                    ...
                    prNumber,
                    prTitle:title,
                    prUrl: `http://github.com/${owner}/${repo}/pull/${prNumber}`,
                    review,
                    status: "completed",
                }
            })
